...
using SpaceOpera.View.Game.StarSystemViews;
...
namespace SpaceOpera.View.Game.Scenes
{
    public class StarSystemScene : GraphicsResource, IGameScene
    {
        ...
        private HighlightLayer<StarSystem, INavigable>? _highlightLayer;
        ...
        public StarSystemScene(
            ...
            HighlightLayer<StarSystem, INavigable> highlightLayer,
