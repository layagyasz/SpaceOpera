    ...
    public class Program
    {
        static void Main()
        {
            ...
            if (mode == 1)
            {
                ...
                var planet =
                    planetGenerator.Generate(
                        ...
                        generatorContext);
                scene = planet;
                controller = new GameController(ui, null, viewFactory, viewFactory.CreatePaneSet(), logger);
            ...
            else if (mode == 4)
            {
                ...
                scene = world.Galaxy;
                controller = new GameController(ui, world, viewFactory, viewFactory.CreatePaneSet(), logger);
